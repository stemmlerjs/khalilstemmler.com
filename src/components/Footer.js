...
const MailChimpSignup = () => (
  <div id="mc_embed_signup">
    <form
      action="https://khalilstemmler.us17.list-manage.com/subscribe/post?u=6816d2889bed041b6e83840af&amp;id=44ae72b287"
      method="post"
    ...
    >
      <div id="mc_embed_signup_scroll">
        ...
        >
          <input
            type="text"
            name="b_6816d2889bed041b6e83840af_44ae72b287"
            tabIndex="-1"
          />
        </div>
        <div>
...
const TopFooter = props => {
  return (
    <div className={styles.topFooter}>
      <div className={styles.mailListCopy}>
        Learn how to optimize and grow your online store on Shopify with weekly
        content.
      </div>
    ...
    <div className={styles.container}>
      ...
      <div className={styles.bottomFooter}>
        ...
        <div className={styles.footerSocialContainer}>
          <a href={'https://twitter.com/stemmlerjs'}>
            <img src={twitter} />
          </a>
          <a href={'https://www.linkedin.com/in/khalilstemmler/'}>
            <img src={linkedIn} />
          </a>
          <a href={'https://instagram.com/stemmlerjs'}>
            <img src={instagram} />
          </a>
