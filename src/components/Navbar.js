  ...
  return (
    ...
    >
      ...
      <Link onClick={props.toggleBurgerMenu} to="/contact">
        <button className={navbarStyles.getStartedButtonOverlay}>
          Get started
        </button>
      </Link>
    </div>
    ...
    return (
      <nav className={navbarStyles.container}>
        ...
        <div className={navbarStyles.navigationItems}>
          <div className={renderActiveIfOnPage('about')}>
            <Link to="/about">About</Link>
          </div>
          <div className={renderActiveIfOnPage('blog')}>
            <Link to="/blog">Blog</Link>
          </div>
          ...
          <div className={renderActiveIfOnPage('contact')}>
            <Link to="/contact">Contact</Link>
          </div>
          <GetStartedButton />
        </div>
